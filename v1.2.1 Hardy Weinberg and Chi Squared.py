...
print(f"Chi-Square Statistic: {round(chi_square_statistic,6)}")
...
if critical_value is None:
    ...
    if chi_square_statistic > critical_value:
        print("Reject the null hypothesis (significantly different - Hardy-Weinberg likely not at equilibrium).")
    else:
        print("Fail to reject the null hypothesis (not significantly different - Hardy-Weinberg likely at equilibrium).")
